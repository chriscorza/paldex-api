...
Proveer un CRUD completo y autenticado para el catálogo de impuestos (`taxes`), con validación de `rate` como porcentaje (0-100), unicidad del nombre y protección de borrado frente a impuestos en uso.
