...
Proveer un sistema de autorización con roles y permisos persistidos y editables en caliente, con denegación por defecto, caché en memoria y protecciones anti-bloqueo.
## Requirements
